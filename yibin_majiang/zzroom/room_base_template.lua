...
function room_base_Template:_do_prepare_init(other_index)
	...
	self.room_base_specil = ui_manager:register_widget_object("room_base_specil",other_index)
	...
	self.room_base_up_fj_img1 = ui_manager:register_widget_object("room_base_up_fj_img1",other_index)
	...
	self.room_base_up_fj_bg_0 = ui_manager:register_widget_object("room_base_up_fj_bg_0",other_index)
