...
PROTOCOL_FORMAT_DICT[0x4010] = {fmt={{name = "msg_data", type = T.STRING}}}--广播账号选择海底牌
PROTOCOL_FORMAT_DICT[0x4011] = {fmt={{name = "msg_data", type = T.STRING}}}--广播房间定飘
PROTOCOL_FORMAT_DICT[0x4012] = {fmt={{name = "msg_data", type = T.STRING}}}--广播房间定定缺
PROTOCOL_FORMAT_DICT[0x4013] = {fmt={{name = "msg_data", type = T.STRING}}}--广播本金与癞子
PROTOCOL_FORMAT_DICT[0x4014] = {fmt={{name = "msg_data", type = T.STRING}}}--广播用户选定缺结果
PROTOCOL_FORMAT_DICT[0x4015] = {fmt={{name = "msg_data", type = T.STRING}}}--广播用户选定飘结果
