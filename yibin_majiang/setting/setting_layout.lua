...
function SettingLayout:_do_after_init()
    ...
    if cc.Application:getInstance():getTargetPlatform() == cc.PLATFORM_OS_WINDOWS then
        self.setting_sendcard:setVisible(true)
    else
        self.setting_sendcard:setVisible(false)
    end
end
...
function SettingLayout:click_setting_sendcard_event()
     ZZ_Send:send(mprotocol.H2G_GAME_MATCHING_CARD,setting.ACCOUNT_HANDCARD)
end