...
function room_handle_view_Template:_do_prepare_init(other_index)
	...
	self.room_handle_view_chi = ui_manager:register_widget_object("room_handle_view_chi",other_index)
	self.room_handle_view_peng = ui_manager:register_widget_object("room_handle_view_peng",other_index)
	self.room_handle_view_buz = ui_manager:register_widget_object("room_handle_view_buz",other_index)
	...
	self.room_handle_view_buz:onClick(handler(self, self.click_room_handle_view_buz_event))
	...
	self.room_handle_view_chi:onClick(handler(self, self.click_room_handle_view_chi_event))
...
function room_handle_view_Template:click_room_handle_view_buz_event()
end
...
function room_handle_view_Template:click_room_handle_view_chi_event()
end
