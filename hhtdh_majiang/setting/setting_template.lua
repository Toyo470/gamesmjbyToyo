...
function setting_Template:_do_prepare_init(other_index)
	...
	self.setting_sendcard = ui_manager:register_widget_object("setting_sendcard",other_index)
	...
	self.setting_sendcard:onClick(handler(self, self.click_setting_sendcard_event))
...
function setting_Template:click_setting_sendcard_event()
end
