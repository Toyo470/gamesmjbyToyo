...
function MatchSetting:showMatchSignup(flag,signcount,totalcount,entryFee,code,matchlevel)
    ...
    local layer_sign = cc.CSLoader:createNode("ddz/csb/LayerSignup.csb"):addTo(SCENENOW["scene"])
...
function MatchSetting:showMatchWin(rank_c,rank_b,round,code)
    ...
    local match_win = cc.CSLoader:createNode("ddz/match/MatchWin.csb"):addTo(SCENENOW["scene"])
...
function MatchSetting:showMatchLose(rank_c,rank_b,round,code)
    ...
    local match_lose = cc.CSLoader:createNode("ddz/match/MatchLose.csb"):addTo(SCENENOW["scene"])
...
function MatchSetting:showMatchWait(flag,code)
    ...
    local match_wait = cc.CSLoader:createNode("ddz/match/MatchWait.csb"):addTo(SCENENOW["scene"])
