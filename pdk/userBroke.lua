...
function userBroke:ctor(isShowLinQu,callOk)
    print("先显示破产");
    local rootNode= cc.CSLoader:createNode("pdk/csb/userPoc.csb"):addTo(self)--先显示破产
    ...
    if not isShowLinQu then
        ...
        btn_ok:onClick(function()
            ...
            -- require("hall.GameData"):setPlayerRoute("pdk","free",USER_INFO["base_chip"],0)
...
function userBroke:rtuHall()
    ...
    if SCENENOW["name"]~="pdk.gameScene" then --zhangzai youxi zhong 
        return;
    end
            ...
            callBack=function(data)
                ...
                if data.returnCode=="0" then--请求破产补助成功
                    ...
                    self.linquSuccess:onClick(function()
                        if SCENENOW["name"]=="pdk.gameScene" then --正在游戏中
                    ...
                    if USER_INFO["hasBlueMonthCard"]==1 then--已经购买蓝卡
                        ...
                        if self.isShowLinQu and SCENENOW["name"]~="pdk.gameScene" then --正在游戏中
