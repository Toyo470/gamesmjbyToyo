...
function calcCards:setCalcs(flag)
    ...
    local spHead = cc.Sprite:create("pdk/card_calc/record_cards_left_text.png"):addTo(calc_ui)
    spHead:setPosition(spHead:getContentSize().width/2, spHead:getContentSize().height/2)

    local spCalcBack = cc.Scale9Sprite:create("pdk/card_calc/record_box.png"):addTo(calc_ui)
    ...
    local spTail = cc.Sprite:create("pdk/card_calc/record_box2.png"):addTo(calc_ui)
...
function calcCards:showTips(msg)
    ...
    local spBack = cc.Scale9Sprite:create("pdk/card_calc/record_text_box.png")
