...
function Animation:animSpring(par)
    ...
    local emitter1 = cc.ParticleSystemQuad:create("pdk/Game/hall_ui/effects/spring/baozha01.plist")
    emitter1:setTexture(cc.Director:getInstance():getTextureCache():addImage("pdk/Game/hall_ui/effects/spring/spring_flower.png"))
    layer:addChild(emitter1)
    emitter1:setDuration(-1)
    emitter1:setAutoRemoveOnFinish(true)
    emitter1:setPosition(cc.p(480, 200))

    local spSpring = display.newSprite("pdk/Game/hall_ui/effects/spring/spring.png")
...
function Animation:Alarm()
    ...
    local light = display.newSprite("pdk/Game/hall_ui/effects/baojing/effect_baodan.png")
    if light then
        ...
        local dl = cc.DelayTime:create(0.5)
        local sq = cc.Sequence:create(dl,cc.Show:create(),dl,cc.Hide:create())
        light:runAction(cc.RepeatForever:create(sq))
		light:setScale(2)
    end

    -- local sp = display.newSprite("pdk/Game/hall_ui/effects/baojing/alarm_fore.png")
    -- if sp then
    --     layer:addChild(sp)
    -- end
...
function Animation:animRocket(par)
    ...
    require("hall.GameCommon"):playEffectSound("pdk/audio/new/CardType_Missile.mp3")  

    display.addSpriteFrames("pdk/Game/hall_ui/effects/rocket/huojian.plist", "pdk/Game/hall_ui/effects/rocket/huojian.png")
...
function Animation:animShun(par,seat)
    ...
    require("hall.GameCommon"):playEffectSound("pdk/audio/new/CardType_One_Line.mp3")
    local lay = display.newNode():addTo(par)
    lay:setName("shunanim")    

    seat = tonumber(seat)
    local pos = {{480,250+50},{660,350+70},{300,350+70}}
    display.addSpriteFrames("pdk/Game/hall_ui/effects/shunzi/shunzi.plist", "pdk/Game/hall_ui/effects/shunzi/shunzi.png")
...
function Animation:animDoubleLine(par)
    ...
    display.addSpriteFrames("pdk/Game/hall_ui/effects/DoubleLine/DoubleLine.plist", "pdk/Game/hall_ui/effects/DoubleLine/DoubleLine.png")
...
function Animation:animPlane(par)
    ...
    local lay = display.newNode():addTo(par)
    lay:setName("shunanim")
    require("hall.GameCommon"):playEffectSound("pdk/audio/new/CardType_Aircraft.mp3")

    display.addSpriteFrames("pdk/Game/hall_ui/effects/plane/plane.plist", "pdk/Game/hall_ui/effects/plane/plane.png")
...
function Animation:animBoom(par)
    ...
    display.addSpriteFrames("pdk/Game/hall_ui/effects/boom.plist", "pdk/Game/hall_ui/effects/boom.png")
