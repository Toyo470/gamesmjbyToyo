...
function ZZ_Handle:ctor()
  ...
  local  func_ = {
      ...
      --游戏开始
      [mprotocol.G2H_BROADCAST_GAME_START]              = {handler(self, ZZ_Handle.G2H_BROADCAST_GAME_START)},
...
function ZZ_Handle:G2H_REFRESH_ACCOUNT_LIST(pack)
  ...
  local game_up_jing_card_list = tbl["game_up_jing_card_list"] or {}
  local game_total_jing_count = tbl["game_total_jing_count"] or 0

  cardhandle.game_up_jing_card_list = game_up_jing_card_list
  cardhandle.game_total_jing_count = game_total_jing_count
  if game_up_jing_card_list[1] ~= nil and game_up_jing_card_list[2] ~= nil then
    game.game_operator.reset_up_jing_list(game_up_jing_card_list[1],game_up_jing_card_list[2],game_total_jing_count)
  end
...
--游戏开始
function ZZ_Handle:G2H_BROADCAST_GAME_START( pack )
  -- body
  if layout == nil then
    return
  end
  ...
  dump(tbl,"G2H_BROADCAST_GAME_START")
...
--广播组局结果
 ...
 function ZZ_Handle:G2H_BROADCAST_GAME_RESULT(pack)
   -- body
    ...
    game.game_operator.show_round_result(tbl)
