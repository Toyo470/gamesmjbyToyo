...
function start_effect_Template:_do_prepare_init(other_index)
	...
	self.start_effect_majiang_bg_right = ui_manager:register_widget_object("start_effect_majiang_bg_right",other_index)
	self.start_effect_majiang_right = ui_manager:register_widget_object("start_effect_majiang_right",other_index)
	self.start_effect_shangjing_img = ui_manager:register_widget_object("start_effect_shangjing_img",other_index)
