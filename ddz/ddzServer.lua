...
function ddzServer:LoginGame()
    ...
    print("ddzServer:LoginGame",mode,tostring(USER_INFO["activity_id"]))
    -- body
...
--出牌
function ddzServer:CLI_PLAYER_CARD(amount,cards)
...
function ddzServer:C2S_DISSOLVE_ROOM()
...
--------解散相关-----------
--请求解散房间
function ddzServer:C2G_CMD_DISSOLVE_ROOM()
...
--回复请求解散房间
function ddzServer:C2G_CMD_REPLY_DISSOLVE_ROOM(agree)
