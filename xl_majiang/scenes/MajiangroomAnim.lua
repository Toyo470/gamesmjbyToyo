...
--加载骰子动画资源
local shaiziPin_map = require("xl_majiang.pintu.MajiangshuaiziMap")

--定义麻将游戏动画类
local MajiangroomAnim = class("MajiangroomAnim")
...
function MajiangroomAnim:ctor()
	-- created with TexturePacker (http://www.texturepacker.com)
end

--骰子动画
function MajiangroomAnim:shuaiZi(point)
	...
	-- local pannel = display.newSprite("xl_majiang/image/shaiziPin.png"):addTo(node)
 ...
 --    end
	...
	-- 		local pannel_one = display.newSprite("xl_majiang/image/".."dian"..tostring(one)..".png"):addTo(node)
	-- 		pannel_one:pos(-60,0)

	-- 		local pannel_two =  display.newSprite("xl_majiang/image/".."dian"..tostring(two)..".png"):addTo(node)
	-- 		pannel_two:pos(60,0)
