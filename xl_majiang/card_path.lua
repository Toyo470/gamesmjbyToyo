...
function CARD_PATH_MANAGER:init()
	...
	--定义图片路径
	local image_path = "xl_majiang/image/"
	...
	--用户默认头像
	card_path_dic["path_default_image"] = "xl_majiang/image/photo_default.png"

	--杠
	card_path_dic["path_other_gang"] =  "xl_majiang/image/quan_gang.png"
	--碰
	card_path_dic["path_other_peng"] = "xl_majiang/image/quan_peng.png"
	--胡
	card_path_dic["path_other_hu"] = "xl_majiang/image/quan_hu.png"
	--听
	card_path_dic["path_ting"] = "xl_majiang/image/quan_ting.png"

	--骰子图片资源
	card_path_dic["shaizi_path"] = "xl_majiang/image/shaiziPin.png"

	--背景光
	card_path_dic["path_guan"] = "xl_majiang/image/Resources/guan.png"

	--数字字体
	card_path_dic["path_font_res"] ="xl_majiang/image/font/num.fnt"
...
function CARD_PATH_MANAGER:get_left_out_card_path(card_value)
	return "xl_majiang/image/card/leftout/"..tostring(card_value)..".png"
end

--获取右边用户打出的牌
function CARD_PATH_MANAGER:get_right_out_card_path(card_value)
	return "xl_majiang/image/card/rightout/"..tostring(card_value)..".png"
end

--获取对家用户打出的牌
function CARD_PATH_MANAGER:get_top_topout_card_path(card_value)
	return "xl_majiang/image/card/topout/"..tostring(card_value)..".png"
end

--获取我手中的牌
function CARD_PATH_MANAGER:get_hand_card_path(card_value)
	return "xl_majiang/image/card/handcard/"..tostring(card_value)..".png"
end

--012对应万筒条
function CARD_PATH_MANAGER:get_que_tip(index)
	return "xl_majiang/image/que_"..tostring(index)..".png"
end
