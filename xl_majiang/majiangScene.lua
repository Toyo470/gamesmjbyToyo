...
--设置父级目录
cc.FileUtils:getInstance():addSearchPath("xl_majiang/")
...
local BloodHallHandle  = require("xl_majiang.scenes.MajiangroomHandle")
 --导入麻将套接字请求处理（协议）
local PROTOCOL         = import("xl_majiang.scenes.Majiang_Protocol")

require("xl_majiang.setting_help")
require("xl_majiang.card_type")
...
function majiangScene:onEnter()
    ...
    --         self:groupRun();
    --     else
    --         display_scene("xl_majiang/gameScenes")
    --     end
