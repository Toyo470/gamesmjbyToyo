local musicManager = require("hn_majiang.utils.music_manager.lua")
...
--         sound_path = "hn_majiang/voice/" .. SOUND_TYPE_CS_MAN .. "/mj" .. card_value .. ".mp3"
--     else
--         sound_path = "hn_majiang/voice/" .. SOUND_TYPE_CS_WOMEN .. "/mj" .. card_value .. ".mp3"
--     end
--     return sound_path
-- end
...
--     sound_path = "hn_majiang/voice/" .. sexPath .. "/" .. controlType .. index .. ".mp3"
...
function VoiceUtils:playBackgroundMusic()
    audio.playMusic("hn_majiang/voice/bgm.mp3",true)
end
