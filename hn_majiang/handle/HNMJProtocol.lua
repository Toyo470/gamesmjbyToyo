...
SERVER[P.SVR_ENDDING_BROADCAST] = {
    ...
    fmt = {
        ...
        {name = "players", type = T.ARRAY,fixedLengthParser = "playercount", fixedLength = 0,
            fmt = {
                {name="uid",type   = T.INT},   --用户id
                {name="isOnline",type  = T.SHORT},   --是否胡牌
                {name="piaovalue",type  = T.BYTE},   --上了多少嘎
                ...
                {name="lianzhuangcount",type = T.BYTE},
                {name="huahu",type = T.BYTE},
...
SERVER[P.SVR_HUAPAI] = {
    ...
    fmt = {
        ...
        {name = "huapaiCount", type = T.BYTE}, --花牌数量
        {name = "huapai", type = T.ARRAY,fixedLengthParser = "huapaiCount",fixedLength = 0,
            fmt = {

                {name = "card", type = T.BYTE},--花牌
            }
        },

        {name = "bupaiCount", type = T.BYTE}, --补牌数量
        {name = "bupai", type = T.ARRAY,fixedLengthParser = "bupaiCount",fixedLength = 0,
            fmt = {

                {name = "card", type = T.BYTE},--补牌
            }
        },
    }   
}
...
SERVER[P.SVR_GROUP_TIME] =  {
    ...
    fmt = {
        ...
        {name = "lianzhuang_round", type = T.BYTE}
    }
}
