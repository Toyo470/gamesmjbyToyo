local musicManager = require("szkawuxing.utils.music_manager.lua")
...
--         sound_path = "szkawuxing/voice/" .. SOUND_TYPE_CS_MAN .. "/mj" .. card_value .. ".mp3"
--     else
--         sound_path = "szkawuxing/voice/" .. SOUND_TYPE_CS_WOMEN .. "/mj" .. card_value .. ".mp3"
--     end
--     return sound_path
-- end
...
--     sound_path = "szkawuxing/voice/" .. sexPath .. "/" .. controlType .. index .. ".mp3"
...
function VoiceUtils:playBackgroundMusic()
    audio.playMusic("szkawuxing/voice/bgm.mp3",true)
end
