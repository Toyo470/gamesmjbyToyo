...
function ResultLayout:_do_after_init()
 ...
 -- print(time_str)
  ...
  self.result_name0:setVisible(false)
  self.result_name1:setVisible(false)
  self.result_name2:setVisible(false)
  self.result_name3:setVisible(false)

  self.result_score0:setVisible(false)
  self.result_score1:setVisible(false)
  self.result_score2:setVisible(false)
  self.result_score3:setVisible(false)
...
function ResultLayout:reset_title_state( state )
  ...
  state = state or 0
  if state == 0 then--流局
    self.result_title:setBackGroundImage("zz_majiang2/res/image/mahjong_lose_bt.png")
    self.result_title_image:loadTexture("zz_majiang2/res/image/text_liuju .png")

  elseif state > 0 then --赢了
    self.result_title:setBackGroundImage("zz_majiang2/res/image/red_button_p.png")
    self.result_title_image:loadTexture("zz_majiang2/res/image/mahjong_win.png")
  else
    self.result_title:setBackGroundImage("zz_majiang2/res/image/mahjong_lose_bt.png")
    self.result_title_image:loadTexture("zz_majiang2/res/image/mahjong_lose.png")
  end
...
function ResultLayout:reset_result_score( index,score )
  ...
  tbl[tonumber(index)]:setVisible(true)
end
...
local zz_majiang2Server = require("zz_majiang2.gd_majiangServer")
zz_majiang2Server:LoginGame()
...
function ResultLayout:click_result_room_btn_quit_room_event()
  local zz_majiang2Server = require("zz_majiang2.gd_majiangServer")
  zz_majiang2Server:c2s_request_dissove()
end
