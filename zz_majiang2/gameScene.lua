...
cc.FileUtils:getInstance():addSearchPath("zz_majiang2/")

require("zz_majiang2.helptool")
require("zz_majiang2.myrequire")
...
function ScriptScene:onEnter()
    ...
    mrequire("keys")
    mrequire("jsonparser")
    print("-------zz_majiang2----ScriptScene:onEnter()----------------")
   -- print("******************env**********************",env)
   --dump(mymodules)
    ...
    local sendHandle = require("zz_majiang2.gd_majiangServer")
...
--dump(ZZPROTOCOL)
    ...
    local ZZPROTOCOL = require("zz_majiang2.gd_Protocol")
    local ZZHandle = require("zz_majiang2.gd_Handle")
