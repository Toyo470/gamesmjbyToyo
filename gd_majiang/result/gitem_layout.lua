...
function GitemLayout:_do_after_init()
  ...
  self.gitem_jiepao:setString("暗杠条数")
  self.gitem_dianpao:setString("明杠条数")
  self.gitem_minggang:setVisible(false)
  self.gitem_angang:setVisible(false)
...
function GitemLayout:reset_itemdata(index,player_data)
  ...
  -- local chips = user_info_tbl["chips"] - user_info_tbl["add_chips"]
  local chips = user_info_tbl["chips"] - USER_INFO["group_chip"]

  self.gitem_zimo_n:setString(tostring(zimo))
  self.gitem_jiepao_n:setString(tostring(angang))
  self.gitem_dianpao_n:setString(tostring(minggang))
  self.gitem_minggang_n:setVisible(false)
  self.gitem_angang_n:setVisible(false)
  self.gitem_sum:setString(tostring(chips))
  ...
  local sp = display.newSprite("gd_majiang/res/image/head_box2.png")
