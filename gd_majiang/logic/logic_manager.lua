...
function Logic_Manager:initialize()
    ...
    --创建用户，初始化用户数据内容
    account.account_operator.init_account_object(USER_INFO["icon_url"],USER_INFO["nick"],0,USER_INFO["sex"],tonumber(UID))

   --  local gd_Handle = require("gd_majiang.gd_Handle")
   --  local tbl = {}
   --  tbl.gold = 100
   --  tbl.seat_id = 0
   -- gd_Handle:SVR_LOGIN_ROOM(tbl)
...
-- }
  --  gd_Handle:SVR_SEND_USER_CARD(pack)
