...
function room_Template:_do_prepare_init(other_index)
	...
	self.room_gold0:setScale(0.7)
	self.room_gold0:setColor(cc.c3b(255, 255, 255))
	self.room_gold1:setScale(0.7)
	self.room_gold1:setColor(cc.c3b(255, 255, 255))
	self.room_gold2:setScale(0.7)
	self.room_gold2:setColor(cc.c3b(255, 255, 255))
	self.room_gold3:setScale(0.7)
	self.room_gold3:setColor(cc.c3b(255, 255, 255))
