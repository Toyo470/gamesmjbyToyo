...
function CardUtils:getPlayerType(seatId)
    local other_index = seatId - KWX_MY_USERINFO.seat_id
...
function CardUtils:removeCards(seatId, removeCards)
	local oriCards = KWX_GAMEINFO_TABLE[seatId .. ""].hand
...
function CardUtils:getNewCard(seatId, value)
	...
	dump(KWX_GAMEINFO_TABLE, "getNewCard KWX_GAMEINFO_TABLE test")
