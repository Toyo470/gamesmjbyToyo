local musicManager = require("xykawuxing.utils.music_manager.lua")
...
--         sound_path = "xykawuxing/voice/" .. SOUND_TYPE_CS_MAN .. "/mj" .. card_value .. ".mp3"
--     else
--         sound_path = "xykawuxing/voice/" .. SOUND_TYPE_CS_WOMEN .. "/mj" .. card_value .. ".mp3"
--     end
--     return sound_path
-- end
...
--     sound_path = "xykawuxing/voice/" .. sexPath .. "/" .. controlType .. index .. ".mp3"
...
function VoiceUtils:playBackgroundMusic()
    audio.playMusic("xykawuxing/voice/bgm.mp3",true)
end
