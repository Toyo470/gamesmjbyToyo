...
--加载骰子动画资源
local shaiziPin_map = require("majiang.pintu.MajiangshuaiziMap")
...
function MajiangroomAnim:shuaiZi(point)
	...
	-- local pannel = display.newSprite("majiang/image/shaiziPin.png"):addTo(node)
 ...
 --    end
	...
	-- 		local pannel_one = display.newSprite("majiang/image/".."dian"..tostring(one)..".png"):addTo(node)
	-- 		pannel_one:pos(-60,0)

	-- 		local pannel_two =  display.newSprite("majiang/image/".."dian"..tostring(two)..".png"):addTo(node)
	-- 		pannel_two:pos(60,0)
