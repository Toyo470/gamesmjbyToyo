...
SERVER[P.SVR_ENDDING_BROADCAST] = {
    ...
    fmt = {
        ...
        {name = "content", type = T.ARRAY,fixedLength = 4,
            fmt = {
                {name="uid",type   = T.INT},   --用户id
                {name="ifhu",type  = T.BYTE,cache=1},   --是否胡牌,0表示没有，1表示胡牌
                {name="ifpao",type = T.BYTE},   --是否放炮,0表示没有，1表示有放炮
                {name="hucontent",type = T.ARRAY,request="ifhu",requestValue=1,fixedLength = 1,
                    fmt = {
                        {name="huOrder",type   = T.INT},--胡牌顺序
                        ...
                        {name="pinghu",type = T.ARRAY,request="hutype",requestValue=1,fixedLength = 1,
                            fmt = {
                                ...
                                {name="paoid",type = T.INT},   --点炮用户id
                                {name="ifgangpao",type = T.BYTE},   --是否杠上炮
                                {name="ifqiangganghu",type = T.BYTE},   --是否抢杠胡
                                {name="ifHaiDiPao",type = T.BYTE}   --是否海底炮
                            }
                        },
                        {name="zimo",type = T.ARRAY,request="hutype",requestValue=2,fixedLength = 1,
                            fmt = {
                                {name="hucard",type = T.BYTE},   --所胡的牌
                                {name="ifgangshanghua",type = T.BYTE},   --是否杠上花
                            }
                        },
                        {name="cardkind",type = T.STRING},   --牌型
                        {name="ifTianHu",type = T.BYTE},   --是否天胡
                        {name="ifDiHu",type = T.BYTE},   --是否地胡
                        {name="ifSaoDi",type = T.BYTE},  --是否扫底胡
                        {name="ifJinGou",type = T.BYTE},   --是否金钩胡
                        {name="fanshu",type = T.BYTE},   --番数
                        {name="allFan",type = T.BYTE},   --总番数
                        {name="money",type = T.INT},   --钱
                        {name="gen",type = T.BYTE},   --根
                        {name="gangnum",type = T.BYTE},   --杠的总次数
                    },

                }, 
                {name="ifgua", type = T.INT},   --刮风下雨所得
                {name="diangangMemberNum", type = T.INT}, --当前用户点了多少个用户杠
                {name="diangangMemberArray", type = T.ARRAY, fixedLengthParser = "diangangMemberNum",fixedLength = 0,
                    fmt = {
                        {name="uid",type = T.INT},   --接杠用户id
                        {name="gangNum",type = T.INT},  --接杠次数
                    }
                },
                {name="ifhua",type = T.BYTE,cache=1},   --是否花猪
                {name="huazhu",type =T.ARRAY,request="ifhua",requestValue=1,fixedLength = 1,
                    fmt = {
                        {name="huamount",type = T.BYTE},   --收钱玩家数量
                        {name="huazhuuids",type=T.ARRAY,fixedLengthParser = "huamount",fixedLength = 0,
                            fmt = {
                                {type = T.INT},   --收钱玩家数量
                             }
                        }
                ...
                {name="ifdajiao",type   = T.BYTE,cache=1},   --是否大叫
                {name="dajiaocontent",type = T.ARRAY,request="ifdajiao",requestValue=1,fixedLength = 1,
                    fmt = {
                        {name="dajiaomout",type   = T.BYTE},   --大叫人数
                        {name="dajiaouserinfo",type=T.ARRAY,fixedLengthParser = "dajiaomout",fixedLength = 0,
                            fmt = {
                                {name="dajiaouid",type = T.INT},   --收钱玩家数量
                                {name="dajiaofan",type = T.INT},   --番数
                                {name="dajiaowin",type = T.INT},   --大叫赢的钱
                             }
                        }

                    }
                },   --大叫内容
                {name="userstatus",type = T.SHORT},   --用户状态
                {name="userleftgold",type = T.INT},   --用户剩余金币数量
                {name="userpergold",type = T.INT},   --用户本轮输赢金币（实际）
                ...
                {name="chiNum",type = T.INT},
                {name="chiArray",type=T.ARRAY,fixedLengthParser = "chiNum",fixedLength = 0,
                    fmt = {
                        {type = T.BYTE},   --pai
                     }
                },
    ...
    fmt = {
        ...
        {name = "content", type = T.ARRAY,fixedLengthParser = "hu_count",fixedLength = 0,
            fmt = {
                ...
                {name="ifJinGou",type = T.BYTE},   --是否金钩胡
                {name="ifHaiDiPao",type = T.BYTE},   --是否海底炮
                {name="gen_mount",type = T.INT},   --根的数量，四张牌的总和减去杠的数量
                {name="gang_mount",type = T.INT},   --杠的数量
                {name="hu_kind",type = T.STRING},   --胡牌类型
                {name="card",type = T.INT},   --胡的牌值
...
SERVER[P.SVR_REGET_ROOM] = {
    ver = 1,
    fmt = {
        {name = "lastCard", type = T.BYTE}, --当前最新的出牌
        {name = "myNowHandle", type = T.INT}, --自己可以进行的操作
        {name = "canGangCount", type = T.INT}, -- 当前用户可以有几个杠
        {name = "canGangArr", type = T.ARRAY, fixedLengthParser = "canGangCount", fixedLength = 0,
            fmt = {
                {type = T.BYTE},   --当前用户具体可以杠的牌
            }
        },
        ...
        {name = "users_info", type = T.ARRAY,fixedLengthParser = "nPlayerCount",fixedLength = 0,
            fmt = {
                    ...
                    {name = "HuType",type = T.BYTE,request="HuSeatId",requestValue=1},--胡牌类型
                    {name = "HuCard",type = T.BYTE,request="HuSeatId",requestValue=1},--胡的牌
        ...
        {name = "pHudate_p", type = T.BYTE,request="pHuSeatId",requestValue=1},--自己胡牌类型
        {name = "pHudate_c", type = T.BYTE,request="pHuSeatId",requestValue=1},--自己胡的牌
        ...
        {name = "isChangeCard",type = T.INT},--是否换牌
