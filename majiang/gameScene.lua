...
function gameScene:hideGropMenu(s)
 ...
 --        require("majiang.ddzSettings"):setEndGroup(0)
 ...
 --                    require("majiang.scenes.MajiangroomServer"):quickRoom()
 --                end
 ...
 --                view            = cc.CSLoader:createNode("majiang/scens/GroupScene.csb"):addTo(this,99999)
...
function gameScene:onChipSuccess(pack)
    ...
    if tonumber(pack["uid"]) == tonumber(UID) then
        ...
        local index=require("majiang.scenes.MajiangroomHandle"):getIndex(pack["uid"])
        --show other user id 
...
function gameScene:onNetBillboard(pack)
    ...
    require("majiang.ddzSettings"):setEndGroup(1)
    require("majiang.scenes.MajiangroomServer"):quickRoom()
