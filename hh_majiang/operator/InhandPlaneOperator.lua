...
-- function InhandPlaneOperator:showCards(playerType, plane, cardDatas,huipai,tingFlag)
	...
	if playerType == CARD_PLAYERTYPE_MY then
		...
		card:addTouchEventListener(function(sender, event)
				if event == TOUCH_EVENT_ENDED then
					--todo
					if sender:getTag() == NEW_CARD_TAG and ZZMJ_CHUPAI == 1 then
