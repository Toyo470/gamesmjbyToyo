...
function ControlPlaneOperator:init(playerType, img, plane, lgPlane, tingHuPlane)
    ...
    light_img:loadTexture("zz_majiang/image/effect/effect_guang.png")
    ...
    effect_3_img:loadTexture("zz_majiang/image/effect/effect_hu03.png")
    ...
    effect_2_img:loadTexture("zz_majiang/image/effect/effect_hu02.png")
    ...
    effect_1_img:loadTexture("zz_majiang/image/effect/effect_hu01.png")
	...
	if plane then
		...
		self.liang_bt:loadTextureNormal("zz_majiang/image/majong_liang_bt_p.png")
...
function ControlPlaneOperator:showImage(img, type)
	...
	effect_1_img:loadTexture("zz_majiang/image/effect/effect_" .. img_type .. "3.png")
	effect_2_img:loadTexture("zz_majiang/image/effect/effect_" .. img_type .. "2.png")
	effect_3_img:loadTexture("zz_majiang/image/effect/effect_" .. img_type .. "1.png")
...
function ControlPlaneOperator:showTingHuPlane(plane, tingHuCards)
	...
	-- dump(plane:getChildren(),"显示听得牌3")
	-- dump(plane:isVisible(),"显示听得牌4")
	end
