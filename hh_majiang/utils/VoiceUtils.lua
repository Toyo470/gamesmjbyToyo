local musicManager = require("zz_majiang.utils.music_manager.lua")
...
--         sound_path = "zz_majiang/voice/" .. SOUND_TYPE_CS_MAN .. "/mj" .. card_value .. ".mp3"
--     else
--         sound_path = "zz_majiang/voice/" .. SOUND_TYPE_CS_WOMEN .. "/mj" .. card_value .. ".mp3"
--     end
--     return sound_path
-- end
...
--     sound_path = "zz_majiang/voice/" .. sexPath .. "/" .. controlType .. index .. ".mp3"
...
function VoiceUtils:playBackgroundMusic()
    audio.playMusic("zz_majiang/voice/bgm.mp3",true)
end
