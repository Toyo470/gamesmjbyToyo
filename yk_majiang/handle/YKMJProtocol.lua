...
SERVER[P.SVR_ENDDING_BROADCAST] = {
    ...
    fmt = {
        ...
        {name = "Qiangtoupai", type = T.BYTE}, -- 墙头牌
        {name = "PublicHuipai", type = T.BYTE}, -- 公共会牌
        {name = "playercount", type = T.BYTE},
        {name = "players", type = T.ARRAY, fixedLength = 0,fixedLengthParser = "playercount",
            fmt = {
                {name="uid",type   = T.INT},   --用户id
                ...
                --旋风杠
                {name="xfgFengCount", type = T.INT},
                {name="xfgJianCount", type = T.INT},
...
SERVER[P.SVR_JIAPIAO_BROADCAST] = {
    ver = 1,
    fmt = {
        {name = "seatid", type = T.BYTE},--座位号
        {name = "Qiangtoupai", type = T.BYTE}, --墙头牌
        {name = "PublicHuipai", type = T.BYTE},--公共会牌（癞子牌）
        {name = "PrivateHuipai_Count", type = T.BYTE},--私人会牌（癞子牌）
        {name = "PrivateHuipai", type = T.ARRAY , fixedLengthParser = "PrivateHuipai_Count",fixedLength = 0,
                  fmt =  {
                              {name = "card",type = T.BYTE},
                         }
        },
...
SERVER[P.SVR_REGET_ROOM] = {
    ...
    fmt = {
        ...
        {name = "nTingFlag", type = T.SHORT}, ----0未听   1可以听  2听状态
...
-- ***********************************************************
        -- 会牌相关
        {name = "Qiangtoupai", type = T.BYTE},
        {name = "Huipai", type = T.BYTE},
        {name = "PrivateHuipai_Count", type = T.BYTE},
        {name = "PrivateHuipai", type = T.ARRAY,fixedLengthParser = "PrivateHuipai_Count",fixedLength = 0,
			fmt = {
                     {name = "card", type = T.BYTE},
             }
...
-- ***********************************************************
        ...
        {name = "users_info", type = T.ARRAY,fixedLengthParser = "nPlayerCount",fixedLength = 0,
            fmt = {
					...
					-- 旋风杠 风牌
                    {name = "xfgFengCount", type = T.SHORT},
                    {name = "xfgFengCards", type = T.ARRAY,fixedLengthParser = "xfgFengCount",fixedLength = 0,
                        fmt = {
                                {name = "card", type = T.BYTE},
                            }
                    },
					...
					-- 旋风杠 箭牌
                    {name = "xfgJianCount", type = T.SHORT},
                    {name = "xfgJianCards", type = T.ARRAY,fixedLengthParser = "xfgJianCount",fixedLength = 0,
                        fmt = {
                                {name = "card", type = T.BYTE},
                            }
                    },
        ...
        {name = "gameStatus", type = T.SHORT},-- 牌桌状态 0：游戏停止状态  1:中间停止状态 2:打牌状态  3：等待操作状态  4：游戏准备停止状态
        ...
        {name = "tingCount", type = T.BYTE},  --可以听的时候的听牌队列
        {name = "tingCards", type = T.ARRAY,fixedLengthParser = "tingCount",fixedLength = 0,
            fmt = {
        ...
        {name = "tingHuCount", type = T.BYTE},--已经听了之后听胡的牌
        {name = "tingHuCards", type = T.ARRAY,fixedLengthParser = "tingHuCount",fixedLength = 0,
            fmt = {
                    {name = "card", type = T.BYTE},--已经听了之后听胡的牌
            }
        },
        

        -- {name = "Qiangtoupai", type = T.BYTE}, --墙头牌
        -- {name = "Huipai", type = T.BYTE},--公共会牌
        -- {name = "PrivateHuipai_Count", type = T.BYTE},--私人会牌
        -- {name = "PrivateHuipai", type = T.ARRAY,fixedLengthParser = "PrivateHuipai_Count",fixedLength = 0,
        --       fmt =  {
        --                   {name = "card",type = T.BYTE},
        --              }
...
SERVER[P.SVR_SEND_USER_CARD] = {
    ...
    fmt = {
		...
		-- @YKLG
        {name = "Qiangtoupai", type = T.BYTE},		-- 反过来的牌
        {name = "Huipai", type = T.BYTE},			-- 会牌
...
SERVER[P.SVR_GAME_OVER] = {
    ver = 1,
    fmt={
        {name= "playercount",type=T.BYTE},--用户id
        {name = "userdate", type = T.ARRAY,fixedLengthParser = "playercount",fixedLength = 0,
            fmt={
