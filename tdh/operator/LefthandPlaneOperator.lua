...
--绘制函数
function LefthandPlaneOperator:addCards(playerType, plane, cardDatas,isAg)
    ...
    elseif isAg==true then
		...
		for i=1,count do
			...
			local card = Card:new(playerType, CARD_TYPE_LEFTHAND, CARD_DISPLAY_TYPE_HIDE, cardData)
