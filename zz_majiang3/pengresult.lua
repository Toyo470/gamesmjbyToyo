local PengResult = class("PengResult")

function PengResult:show_hu_result( index )
	-- body
	print("--------------show_handle_result----------2----------------")
...
function PengResult:show_handle_result( index,result_tbl )
	-- body
	print("--------------show_handle_result----------1----------------")
	local pos = {cc.p(273.23,307.74),cc.p(464.86,406.29),cc.p(656.02,307.74)}
	pos[0] = cc.p(467.57,194.21)

	local effect_hu03_image_path = "zz_majiang3/res/image/effect_peng03.png"
	local effect_peng02 = "zz_majiang3/res/image/effect_peng02.png"
	local effect_peng01 = "zz_majiang3/res/image/effect_peng01.png" 
	if result_tbl['g'] or result_tbl['pg'] then
		effect_hu03_image_path = "zz_majiang3/res/image/effect_gang03.png"
		effect_peng02 = "zz_majiang3/res/image/effect_gang02.png"
		effect_peng01 = "zz_majiang3/res/image/effect_gang01.png" 
	elseif result_tbl['p'] then
        effect_hu03_image_path = "zz_majiang3/res/image/effect_peng03.png"
        effect_peng02 = "zz_majiang3/res/image/effect_peng02.png"
        effect_peng01 = "zz_majiang3/res/image/effect_peng01.png"
	end
