...
function ResultLayout:_do_after_init()
  ...
  self.result_config:setString("红中麻将："..gameConfig)
...
function ResultLayout:reset_title_state( state )
  ...
  state = state or 0
  if state == 0 then--流局
    self.result_title:setBackGroundImage("zz_majiang3/res/image/mahjong_lose_bt.png")
    self.result_title_image:loadTexture("zz_majiang3/res/image/text_liuju .png")

  elseif state > 0 then --赢了
    self.result_title:setBackGroundImage("zz_majiang3/res/image/red_button_p.png")
    self.result_title_image:loadTexture("zz_majiang3/res/image/mahjong_win.png")
  else
    self.result_title:setBackGroundImage("zz_majiang3/res/image/mahjong_lose_bt.png")
    self.result_title_image:loadTexture("zz_majiang3/res/image/mahjong_lose.png")
  end
