...
require("zz_majiang3.helptool")
require("zz_majiang3.myrequire")
...
function ScriptScene:onEnter()
    ...
    mrequire("keys")
    mrequire("jsonparser")
    print("------zz_majiang3-----ScriptScene:onEnter()----------------")
   -- print("******************env**********************",env)
   --dump(mymodules)
    ...
    local sendHandle = require("zz_majiang3.zz_majiangServer")
...
--dump(ZZPROTOCOL)
    ...
    local ZZPROTOCOL = require("zz_majiang3.ZZ_Protocol")
    local ZZHandle = require("zz_majiang3.ZZ_Handle")
