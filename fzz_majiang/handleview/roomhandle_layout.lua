...
local function LuaSplit(str, split_char)  
	...
	require("hall.common.ShareLayer"):showShareLayer("快速红中麻将，房号：" .. USER_INFO["invote_code"], "https://a.mlinks.cc/AK3b", "url", share_content)
...
function HandleLayout:click_roomhandle_room_btn_quit_room_event()
	...
	--end
	 ...
	 --local result_tbl = {}
	-- --result_tbl['p'] = 1
	 --require("fzz_majiang.pengresult"):show_handle_result(0,result_tbl)
	-- require("fzz_majiang.pengresult"):show_handle_result(1,result_tbl)
	-- require("fzz_majiang.pengresult"):show_handle_result(2,result_tbl)
	-- require("fzz_majiang.pengresult"):show_handle_result(3,result_tbl)
	 -- require("fzz_majiang.pengresult"):show_hu_result(0)
	 -- require("fzz_majiang.pengresult"):show_hu_result(1)
	 -- require("fzz_majiang.pengresult"):show_hu_result(2)
	 -- require("fzz_majiang.pengresult"):show_hu_result(3)
