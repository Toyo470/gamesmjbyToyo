...
cc.FileUtils:getInstance():addSearchPath("fzz_majiang/")

require("fzz_majiang.helptool")
require("fzz_majiang.myrequire")
...
function ScriptScene:onEnter()
    ...
    mrequire("keys")
    mrequire("jsonparser")
    print("------fzz_majiang-----ScriptScene:onEnter()----------------")
   -- print("******************env**********************",env)
   --dump(mymodules)
    ...
    local sendHandle = require("fzz_majiang.zz_majiangServer")
...
--dump(ZZPROTOCOL)
    ...
    local ZZPROTOCOL = require("fzz_majiang.ZZ_Protocol")
    local ZZHandle = require("fzz_majiang.ZZ_Handle")
